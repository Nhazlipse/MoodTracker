                    ...
                    <?php else: ?>
                        <div class="post-main">
                            <div class="mood-entry-header">
                                <div class="history-mood"><?= htmlspecialchars($entry['mood']) ?></div>
                                <div class="history-content">
                                    <div class="history-meta">Oleh <strong><?= htmlspecialchars($entry['username']) ?></strong> pada <?= date('l, d F Y', strtotime($entry['date'])) ?></div>
